...
const {addproduct,allproducts,updateproduct,getproduct,deleteproduct,reviewproduct,getAllReviews,deletereview,FilterProducts,SearchProduct} = require('../controllers/product');
...
prodrouter.get('/search',SearchProduct)
